...
import totalPnlDisplayModule from '../../../shared/totalPnlDisplay.js';

const {
  TOTAL_PNL_TIMEFRAME_OPTIONS: TIMEFRAME_OPTIONS,
  buildTotalPnlDisplaySeries,
} = totalPnlDisplayModule?.default || totalPnlDisplayModule;
